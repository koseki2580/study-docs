...
![イメージ図](/img/svg/Algorithm/queue/queue-1.drawio.svg "キュー")
...
![イメージ図](/img/svg/Algorithm/queue/queue-2.drawio.svg "デキュー")

### Enqueue 
データを後ろに入れる処理。言語により、名称が異なるが一般的にキューのデータ構造でデータを入れる処理を`Enqueue`という。

![イメージ図](/img/svg/Algorithm/queue/queue-3.drawio.svg "エンキュー")
